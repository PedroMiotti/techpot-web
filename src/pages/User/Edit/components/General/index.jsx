...
const General = () => {
  ...
  const userEditedErrorMessage = useSelector(
    (state) => state.entitie.user.errorMessage
  );
  const userEditedSuccess = useSelector((state) => state.entitie.user.success);
  const userEditedSuccessMessage = useSelector(
    (state) => state.entitie.user.successMessage
  );
  ...
  useEffect(() => {
    ...
    if (perfil) {
      ...
      if (perfil.occupation) setOcupacaoInput(perfil.occupation);
  ...
  return (
    <>
      <div className="editUserContainer font-techpot">
        ...
        >
          ...
          <div className="editBioContainer editUserContainerPadrao">
            <div className="editUserContainerPadrao-col1">
              <h2>
                Bio <span>- Conte-nos mais sobre voce</span>
              </h2>
            </div>
      ...
      {userEditedFailed && (
        <SnackMessage
          message={userEditedErrorMessage}
          color={"error"}
          show={userEditedFailed}
        />
      )}

      {userEditedSuccess && (
        <SnackMessage
          message={userEditedSuccessMessage}
          color={"success"}
          show={userEditedSuccess}
        />
      )}
    </>
  );

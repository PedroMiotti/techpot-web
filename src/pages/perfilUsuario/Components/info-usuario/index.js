    ...
    return (
        <div id="InfoUsuario" className="font-techpot">
            ...
            <div id="DescricaoUsuario">
                ...
                <p id="NickCat">
                    <p>@CarlosRafael</p>
                    <p>&middot; Professor</p>
                </p>
                <p id="Bio">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus non pulvinar nisi. Maecenas vestibulum justo ex, vitae malesuada massa blandit et. Aliquam dictum ante vel eros dictum dapibus. In fermentum, turpis et pulvinar porta augue.</p>
                <p id="BotaoSocial">
